      ...
      <div className="container-brand">
        <div className="flex items-start justify-between gap-6">
          ...
          <div className="text-right pt-3">
            <div className="font-mono-brand text-[11px] uppercase tracking-widest text-ink/70">01 // Services</div>
          ...
          {cards.map((c, idx) => (
            ...
            >
              ...
              <div className="absolute top-4 left-4">
                <span className="rounded-full bg-cream/90 px-3 py-1 font-mono-brand text-[10px] uppercase tracking-widest text-ink">
                  {c.badge} / Service
                </span>
              </div>
